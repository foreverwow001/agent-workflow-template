...
使用方式：
    python .agent/skills/git-stats-reporter/scripts/git_stats_reporter.py <diff_file_path>
"""
...
def error_result(summary: str, suggestion: str | None = None) -> Dict[str, Any]:
    result: Dict[str, Any] = {
        ...
        "summary": summary,
        "usage": "python .agent/skills/git-stats-reporter/scripts/git_stats_reporter.py <diff_file_path>",
    }
    if suggestion:
