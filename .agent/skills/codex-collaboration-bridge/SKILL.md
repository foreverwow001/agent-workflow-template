---
name: codex-collaboration-bridge
description: "Use when delegating large code changes to Codex CLI, generating implementation specs for terminal execution, or coordinating IDE-agent plus terminal-agent collaboration."
---
...
4. **驗證流程**：要求使用者執行完畢後回報，並由主 Agent 執行 `view_file` 與 `code-reviewer` canonical script 進行檢查。
