---
name: explore-cli-tool
description: "Use when first exploring a new CLI tool, checking supported flags, verifying subcommand syntax, or avoiding guessed command-line parameters."
---
...
探索完成後，請將結果記錄至 `doc/TOOL_USAGE.md`，方便後續使用。
