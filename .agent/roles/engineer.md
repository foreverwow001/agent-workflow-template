...
- 嚴格遵守 `project_rules.md` 中的「開發技術規範」。
...
| 技能 | 用途 | 調用指令 |
|------|------|----------|
| **代碼審查** | 檢查 API Key 洩漏、檔案長度、中文註釋 | `python .agent/skills/code-reviewer/scripts/code_reviewer.py <file_path>` |
...
| **GitHub 技能搜尋** | 從 GitHub 搜尋外部技能 | `python .agent/skills/github-explorer/scripts/github_explorer.py search <keyword>` |
| **技能預覽** | 預覽技能內容 (下載前必做) | `python .agent/skills/github-explorer/scripts/github_explorer.py preview <repo>` |
